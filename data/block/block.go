//go:generate protoc -I=. -I=$GOPATH/src -I=$GOPATH/src/github.com/dharitri/protobuf/protobuf  --gogoslick_out=$GOPATH/src block.proto
package block
...
import (
	...
	"github.com/subrahamanyam341/andes-core-16/data/headerVersionData"
)

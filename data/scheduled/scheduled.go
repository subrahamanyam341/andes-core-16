//go:generate protoc -I=. -I=$GOPATH/src -I=$GOPATH/src/github.com/dharitri/protobuf/protobuf  --gogoslick_out=. scheduled.proto
package scheduled

import (
	"github.com/subrahamanyam341/andes-core-16/data"
	"github.com/subrahamanyam341/andes-core-16/data/block"
	"github.com/subrahamanyam341/andes-core-16/data/smartContractResult"
	"github.com/subrahamanyam341/andes-core-16/data/transaction"
)

//go:generate protoc -I=. -I=$GOPATH/src/github.com/subrahamanyam341/andes-core-16/data/block -I=$GOPATH/src -I=$GOPATH/src/github.com/dharitri/protobuf/protobuf --gogoslick_out=$GOPATH/src outportBlock.proto
